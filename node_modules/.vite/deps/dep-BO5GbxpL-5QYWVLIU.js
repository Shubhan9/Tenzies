...
// node_modules/vite/dist/node/chunks/dep-BO5GbxpL.js
...
var Tokenizer = class {
  ...
  _leaveAttrName() {
    ...
    if (getTokenAttr(token, this.currentAttr.name) === null) {
      ...
      if (token.location && this.currentLocation) {
        const attrLocations = (_a$1 = (_b = token.location).attrs) !== null && _a$1 !== void 0 ? _a$1 : _b.attrs = /* @__PURE__ */ Object.create(null);
  ...
  _stateAfterDoctypeName(cp) {
    ...
    switch (cp) {
      ...
      default:
        if (this._consumeSequenceIfMatch(SEQUENCES.PUBLIC, false)) this.state = State.AFTER_DOCTYPE_PUBLIC_KEYWORD;
...
//# sourceMappingURL=dep-BO5GbxpL-5QYWVLIU.js.map
