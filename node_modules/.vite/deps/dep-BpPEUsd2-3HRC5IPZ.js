import {
  require_lib
} from "./chunk-XB4G2BMH.js";
import {
  __commonJS
} from "./chunk-BSAJHCYF.js";
import {
  require_module
} from "./chunk-VVE2DGAM.js";
import {
  __toESM
} from "./chunk-7D4SUZUM.js";

// node_modules/vite/dist/node/chunks/dep-BpPEUsd2.js
...
var require_FileSystemLoader = __commonJS({ "../../node_modules/.pnpm/postcss-modules@6.0.1_postcss@8.5.6/node_modules/postcss-modules/build/FileSystemLoader.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.default = void 0;
  var _postcss$1 = _interopRequireDefault$21(require2("postcss"));
  var _path = _interopRequireDefault$21(require2("path"));
  var _Parser$1 = _interopRequireDefault$21(require_Parser());
  var _fs$1 = require_fs();
  function _interopRequireDefault$21(obj) {
    return obj && obj.__esModule ? obj : { default: obj };
  }
  var Core = class Core2 {
    constructor(plugins) {
      this.plugins = plugins || Core2.defaultPlugins;
    }
...
var require_node = __commonJS({ "../../node_modules/.pnpm/util-deprecate@1.0.2/node_modules/util-deprecate/node.js"(exports, module) {
  module.exports = require2("util").deprecate;
} });
  ...
  function localizeNode(rule, mode, localAliasMap) {
    const transform = (node, context) => {
      ...
      switch (node.type) {
        ...
        case "nesting":
          if (node.value === "&") context.hasLocals = rule.parent[isPureSelectorSymbol];
      }
      context.lastWasSpacing = false;
      context.ignoreNextSpacing = false;
      context.enforceNoSpacing = false;
        ...
        function localizeNode$1(node) {
          switch (node.type) {
            case "selector":
              ...
              return node;
            case "class":
              return selectorParser.className({ value: exportScopedName(node.value, node.raws && node.raws.value ? node.raws.value : null, node) });
            case "id":
              return selectorParser.id({ value: exportScopedName(node.value, node.raws && node.raws.value ? node.raws.value : null, node) });
            case "attribute":
              if (node.attribute === "class" && node.operator === "=") return selectorParser.attribute({
...
var require_pluginFactory = __commonJS({ "../../node_modules/.pnpm/postcss-modules@6.0.1_postcss@8.5.6/node_modules/postcss-modules/build/pluginFactory.js"(exports) {
  ...
  var _postcss = _interopRequireDefault(require2("postcss"));
...
var dep_BpPEUsd2_default = require_build();
export {
  dep_BpPEUsd2_default as default
};
//# sourceMappingURL=dep-BpPEUsd2-3HRC5IPZ.js.map
