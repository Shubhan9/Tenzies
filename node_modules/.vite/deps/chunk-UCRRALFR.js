...
var Identifier2 = class extends IdentifierBase {
  ...
  includeDestructuredIfNecessary(context, destructuredInitPath, init) {
    ...
    const { propertyReadSideEffects } = this.scope.context.options.treeshake;
    if (this.included ||= destructuredInitPath.length > 0 && !context.brokenFlow && propertyReadSideEffects && (propertyReadSideEffects === "always" || init.hasEffectsOnInteractionAtPath(destructuredInitPath, NODE_INTERACTION_UNKNOWN_ACCESS, createHasEffectsContext()))) {
...
var MemberExpression2 = class extends NodeBase {
  ...
  includeDestructuredIfNecessary(context, destructuredInitPath, init) {
    if (this.included ||= destructuredInitPath.length > 0 && !context.brokenFlow && init.hasEffectsOnInteractionAtPath(destructuredInitPath, NODE_INTERACTION_UNKNOWN_ACCESS, createHasEffectsContext())) {
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-3L5ZBMZH.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-UCRRALFR.js.map
